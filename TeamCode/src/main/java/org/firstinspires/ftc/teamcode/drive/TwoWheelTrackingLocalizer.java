...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -5.875;//; // 6 //-5.27;//-5.75 // X is the up and down direction
    public static double PARALLEL_Y = 3.875;//4.2;//3.25; // Y is the strafe direction

    public static double PERPENDICULAR_X = -5.5;//-6.25;
    public static double PERPENDICULAR_Y = -3.25;//-4.2;
